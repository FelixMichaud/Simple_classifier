...
class Classifier(nn.Module):
    ...
    def __init__(self, frame_dim: int = 4000, n_classes: int = 25):
        ...
        self.linear2 = nn.Linear(in_features=64*32, out_features=n_classes)
    ...
    def forward(self, x):
        ...
        x6bis = self.Pool3(x5.permute(0, 2, 1)).permute(0, 2, 1)
        
        x6 = self.dropout(self.relu(self.linear1(x6bis)))
